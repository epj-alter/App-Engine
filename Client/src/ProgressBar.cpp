...
namespace Engine
{
	Engine::ProgressBar::ProgressBar(GameEntity* parent, int x, int y, int width, int height, const float& current_value, const float& max_value, bool show_percentage)
	...
	void Engine::ProgressBar::update()
	{
		mPercentage = (mCurrentValue * mMaxPercentage) / mMaxValue;
	...
	void Engine::ProgressBar::render()
	{
